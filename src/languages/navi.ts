...
const language = <languages.IMonarchLanguage>{
  ...
  typeKeywords: ["int", "float", "char", "bool", "string"],
...
export const addNaviLanguage = (monaco: Monaco) => {
  monaco.languages.register({ id: "navi" });

  monaco.languages.setMonarchTokensProvider("navi", language);
};
